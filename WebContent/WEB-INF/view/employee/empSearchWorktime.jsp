    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark py-3 font-weight-bold">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="empWriteWorktime.html">填寫工時</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">查詢工時</a>
                </li>
            </ul>
					            ...
					            <div class="modal-dialog modal-lg" role="document">
					                <div class="modal-content">
					                    ...
					                    <div class="modal-body">
					                        <iframe src="WorktimeDetail?action=getWorktimeDetail&weekFirstDay=${worktime.weekFirstDay}" frameborder="0" height="400px" width="1150px"></iframe>
					                    </div>
