function CalendarApp(date) {
    ...
    //closeBtn
    this.dayViewExitBtn = document.getElementById("dayViewExitBtn");
    ...
    this.todayIsSpan.textContent = "今天的日期 " + [date.getMonth()+1] + "月 " + date.getDate() +"日";  
  }
  ...
  CalendarApp.prototype.addEventListeners = function(){
    ...
    this.dayViewExitBtn.addEventListener("click", this.closeDayWindow.bind(this));
  ...
  CalendarApp.prototype.showView = function(date){
    ...
    console.log(lastM.getMonth())
    console.log(this.months[lastM.getMonth()])
  ...
  CalendarApp.prototype.openDayWindow = function(date){
    ...
    this.dayViewDateEle.textContent = this.days[day.getDay()] + ", "   + day.getFullYear() + "年, "+ [day.getMonth()+1] + "月" + day.getDate() + "日";
    this.dayViewDateEle.setAttribute('data-date', day);
    youWant=day.getFullYear() + '-' + (day.getMonth() + 1) + '-' + day.getDate(); 
    this.holiday.setAttribute('value', youWant);
